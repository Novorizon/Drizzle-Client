...
namespace Mathematica
{
    public static partial class Physics
    {
        ...
        public static bool IsOverlap(AABB a, float3 point, Axis axis = Axis.Default) => IsOverlap(a, point);
        public static bool IsOverlap(float3 point, AABB a, Axis axis = Axis.Default) => IsOverlap(a, point);
        public static bool IsOverlap(OBB a, float3 point, Axis axis = Axis.Default) => IsOverlap(a, point);
        public static bool IsOverlap(float3 point, OBB a, Axis axis = Axis.Default) => IsOverlap(a, point);
        public static bool IsOverlap(Sphere a, float3 point, Axis axis = Axis.Default) => IsOverlap(a, point);
        public static bool IsOverlap(float3 point, Sphere a, Axis axis = Axis.Default) => IsOverlap(a, point);
        public static bool IsOverlap(Capsule a, float3 point, Axis axis = Axis.Default) => IsOverlap(a, point);
        public static bool IsOverlap(float3 point, Capsule a, Axis axis = Axis.Default) => IsOverlap(a, point);
