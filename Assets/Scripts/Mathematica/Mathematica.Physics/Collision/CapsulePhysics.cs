...
namespace Mathematica
{
    ...
    {
        //任意轴向
        internal static bool IsOverlap(Capsule capsule, float3 point)
        {
            //判断与中心点1的距离
            ...
            float2 extremePoints = ExtremeProjectPoint(capsule.Center1 - capsule.Center2, new float3[] { capsule.Center1, capsule.Center2 });
        ...
        {
            //端点距离
            float dis = (a.Radius + b.Radius) * (a.Radius + b.Radius);
